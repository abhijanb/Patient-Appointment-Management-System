...
patientRouter.post("/appointments/:id/rate", asyncHandler(appointmentController.rateAppointment));
patientRouter.patch("/appointments/:id/cancel", asyncHandler(appointmentController.cancelAppointment));
